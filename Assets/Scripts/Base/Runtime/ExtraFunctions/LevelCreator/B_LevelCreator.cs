...
public class B_LevelCreator : SerializedMonoBehaviour {
    ...
    void LoadLevel() {
        ...
        GameObject PickedObject = Resources.Load<GameObject>(B_Database_String.Path_Res_MainLevels + SelectedLevel);
        currentLevel = PrefabUtility.InstantiatePrefab(PickedObject, transform) as GameObject;
    ...
    void CreateNewLevel() {
        ...
        currentLevel = Instantiate(PickedObject, transform);
