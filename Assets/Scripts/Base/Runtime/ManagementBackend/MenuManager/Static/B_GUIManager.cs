...
namespace Base.UI {
    public static class B_GUIManager {
        ...
        public static void CreateGUIPanel() {
            var PickedObject = Resources.Load<GameObject>("GUIComponents/PanelSubframe");
            var SelectedObject = Selection.activeGameObject.transform;

            var createdobj = Object.Instantiate(PickedObject);
        ...
        public static void CreateGUISlider() {
            var PickedObject = Resources.Load<GameObject>("GUIComponents/SliderSubframe");
            var SelectedObject = Selection.activeGameObject.transform;
        ...
        public static void CreateGUIImage() {
            var PickedObject = Resources.Load<GameObject>("GUIComponents/ImageSubframe");
            var SelectedObject = Selection.activeGameObject.transform;
        ...
        public static void CreateGUITMProText() {
            var PickedObject = Resources.Load<GameObject>("GUIComponents/TMProGUISubframe");
            var SelectedObject = Selection.activeGameObject.transform;
        ...
        public static void CreateGUITMProButton() {
            var PickedObject = Resources.Load<GameObject>("GUIComponents/ButtonGUISubframe");
            var SelectedObject = Selection.activeGameObject.transform;
        ...
        public static void CreateGUIToggle() {
            var PickedObject = Resources.Load<GameObject>("GUIComponents/ToggleSubframe");
            var SelectedObject = Selection.activeGameObject.transform;
