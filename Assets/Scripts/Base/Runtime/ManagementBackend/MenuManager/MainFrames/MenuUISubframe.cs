...
#pragma warning restore CS1998
        ...
        public void SetSubComponents() {
            ...
            foreach (var PickedInventorySlot in SubComponents) PickedInventorySlot.SetupComponentSubframe(this);
        }

        private void GetAllSubComponents(Transform PickedInventorySlot) {
            foreach (Transform child in PickedInventorySlot) {
