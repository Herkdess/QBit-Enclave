namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class ItemRestrictionSetObjectInspector : InspectorBase
    {
        ...
        protected override void CreateInspector(VisualElement container)
        {
            ...
            var itemRestrictionReorderableList = new ItemRestrictionReorderableList(m_ItemRestrictionSetObject.ItemRestrictionSet.RestrictionList);
    ...
    public class ItemRestrictionReorderableList : VisualElement
    {
        ...
        public ItemRestrictionReorderableList(List<IItemRestriction> list)
        {
            m_List = list;
            ...
            m_RestrictionField = new RestrictionField();
